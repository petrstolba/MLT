...
$$G(x,y) = \frac{1}{n} \sum_{i=1}^{n} \frac{|x_{in} - x_{jn}|}{range(n)} $$
...
ggplot(D, aes(x=a, y=b, color = as.factor(c))) +
      geom_point() +
      geom_point(data = point) +
      geom_line(data = D[c(1,distInd[1]),], aes(x=a, y= b), inherit.aes = F, color = "gray45")
```
...
ggplot(D, aes(x=a, y=b, color = as.factor(c))) +
      ...
      geom_point(data = point) +
      geom_line(data = D[c(1,distInd[1]),], aes(x=a, y= b), inherit.aes = F, color = "gray45") +
      geom_line(data = D[c(1,distInd[2]),], aes(x=a, y= b), inherit.aes = F, color = "gray45")
```
...
ggplot(D, aes(x=a, y=b, color = as.factor(c)))+ 
      ...
      geom_line(data = D[c(1,distInd[1]),], aes(x=a, y= b), inherit.aes = F, color = "gray45") +
      geom_line(data = D[c(1,distInd[2]),], aes(x=a, y= b), inherit.aes = F, color = "gray45") +
      geom_line(data = D[c(1,distInd[3]),], aes(x=a, y= b), inherit.aes = F, color = "gray45") +
      geom_line(data = D[c(1,distInd[4]),], aes(x=a, y= b), inherit.aes = F, color = "gray45") +
      geom_line(data = D[c(1,distInd[5]),], aes(x=a, y= b), inherit.aes = F, color = "gray45")
...
## kNN algorithm
- classic implementation: "class::knn"
